...
/**
 Base class for all TeaStrength views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TeaStrength view hierarchy (such as wrapped iOS UIViews) was touched.
