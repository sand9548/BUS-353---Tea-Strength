...
// in simulator we redefine to format for TeaStrength Developer console
...
{\
	NSString * exceptionName = [@"org.teastrength." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.teastrength";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITeaStrengthNativeItemNone = -1, 
	UITeaStrengthNativeItemSpinner = -2,
	UITeaStrengthNativeItemProgressBar = -3,
	
	UITeaStrengthNativeItemSlider = -4,
	UITeaStrengthNativeItemSwitch = -5,
	UITeaStrengthNativeItemMultiButton = -6,
	UITeaStrengthNativeItemSegmented = -7,
	
	UITeaStrengthNativeItemTextView = -8,
	UITeaStrengthNativeItemTextField = -9,
	UITeaStrengthNativeItemSearchBar = -10,
	
	UITeaStrengthNativeItemPicker = -11,
	UITeaStrengthNativeItemDatePicker = -12,
	
	UITeaStrengthNativeItemInfoLight = -13,
	UITeaStrengthNativeItemInfoDark = -14,
	
	UITeaStrengthNativeItemDisclosure = -15,
	
	UITeaStrengthNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TeaStrength instances of
