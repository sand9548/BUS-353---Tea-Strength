...
@interface TeaStrengthObject : KrollCoverageObject {
#else
@interface TeaStrengthObject : KrollObject {
#endif
@private
...
extern NSString * TeaStrength$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TeaStrengthObject *_teastrength;
    KrollObject* console;
	BOOL shutdown;
