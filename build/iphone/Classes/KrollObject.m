...
//@interface TeaStrengthObject : NSObject
//@end

@interface TeaStrengthObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TeaStrengthObject class]])
		{
			for (NSString *key in [[(TeaStrengthObject*)o modules] allKeys])
			{
